...
const handler = async (m, { conn, args, usedPrefix }) => {
   ...
   const res = await fetch('https://api.github.com/repos/KillzN/KzN2004');
   ...
   txt += `${tradutor.texto1[11]}\n_${usedPrefix}gitclone ${json?.html_url || 'https://github.com/KillzN/KzN2004'}_`;
...
handler.command = ['scrawdawdawdtipt', 'reposiawdawdawtorio', 'readwadwapo']
